...
ALTER TABLE IF EXISTS public.cust_request_status DROP COLUMN IF EXISTS status_datetime;
...
ALTER TABLE public.geo_point
    ALTER COLUMN latitude TYPE numeric(18, 6) COLLATE pg_catalog."default";

ALTER TABLE IF EXISTS public.geo_point
    ALTER COLUMN latitude SET STORAGE MAIN;

ALTER TABLE public.geo_point
    ALTER COLUMN longitude TYPE numeric(18, 6) COLLATE pg_catalog."default";
...
ALTER TABLE IF EXISTS public.product DROP COLUMN IF EXISTS weight;
...
ALTER TABLE IF EXISTS public.product
    ADD COLUMN shipping_weight numeric(18, 6);
